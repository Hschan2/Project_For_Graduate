...
try{
	...
	if(list.equals("hire")){
	sqlList = "select user_number, title, hire, collage, sex, money from user_company where title like ? order by user_number desc"; 
	}
	else if(list.equals("personal")){
	sqlList = "select user_number, title, hire, sex, special, area from user_personal where title like ? order by user_number desc"; 
	}
...
<div id="content">
	...
	<% } %>
	<%
	if(list.equals("personal")){	
	%>
	<tr>
	<th width="73" height=30><font size=3><b>번호</b></font></th>
	<th width="310"><font size=3><b>제목</b></font></th>
	<th width="164"><font size=3><b>고용형태</b></font></th>
	<th width="141"><font size=3><b>성별</b></font></th>
	<th width="38"><font size=3><b>특기사항</b></font></th>
	<th width="20"><font size=3><b>지역</b></font></th>
	</tr>
	<% } %>
	</tr>
<%
...
<%
	if(list.equals("hire")){
	%>
<td><a href="hireok.jsp?user_number=<%=rs.getString(1) %>"><%=rs.getString(2)%></td> 
<%}else if(list.equals("personal")){
%>
<td><a href="personalok.jsp?user_number=<%=rs.getString(1) %>"><%=rs.getString(2)%></td> 
<%} %>
