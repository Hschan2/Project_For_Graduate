...
<div id="content">
       ...
       <div class="row">
		...
		<form name=regform method="post" action="personalregok.jsp">
		<table class="three" width = "100%">
			...
			<tr>
				<th bgcolor = "#EAEAEA">지역</th>
				<td>
				<input type="checkbox" id="checkbox1" class="css-checkbox" name="area" value="서울">
				<label for="checkbox1" class="css-label lite-green-check">서울&nbsp;&nbsp;</label>
				<input type="checkbox" id="checkbox2" class="css-checkbox" name="area" value="경기">
				<label for="checkbox2" class="css-label lite-green-check">경기&nbsp;&nbsp;</label>
				<input type="checkbox" id="checkbox3" class="css-checkbox" name="area" value="인천">
				<label for="checkbox3" class="css-label lite-green-check">인천&nbsp;&nbsp;</label>
				<input type="checkbox" id="checkbox4" class="css-checkbox" name="area" value="강원">
				<label for="checkbox4" class="css-label lite-green-check">강원&nbsp;&nbsp;</label>
				<input type="checkbox" id="checkbox5" class="css-checkbox" name="area" value="충남">
				<label for="checkbox5" class="css-label lite-green-check">충남&nbsp;&nbsp;</label>
				<input type="checkbox" id="checkbox6" class="css-checkbox" name="area" value="충북">
				<label for="checkbox6" class="css-label lite-green-check">충북&nbsp;&nbsp;</label>
				<input type="checkbox" id="checkbox7" class="css-checkbox" name="area" value="대전">
				<label for="checkbox7" class="css-label lite-green-check">대전&nbsp;&nbsp;</label>
				<input type="checkbox" id="checkbox8" class="css-checkbox" name="area" value="경북">
				<label for="checkbox8" class="css-label lite-green-check">경북&nbsp;&nbsp;</label>
				<input type="checkbox" id="checkbox9" class="css-checkbox" name="area" value="경남">
				<label for="checkbox9" class="css-label lite-green-check">경남&nbsp;&nbsp;</label>
				<input type="checkbox" id="checkbox10" class="css-checkbox" name="area" value="대구">
				<label for="checkbox10" class="css-label lite-green-check">대구&nbsp;&nbsp;</label>
				<input type="checkbox" id="checkbox11" class="css-checkbox" name="area" value="부산">
				<label for="checkbox11" class="css-label lite-green-check">부산&nbsp;&nbsp;</label>
				<input type="checkbox" id="checkbox12" class="css-checkbox" name="area" value="전남">
				<label for="checkbox12" class="css-label lite-green-check">전남&nbsp;&nbsp;</label>
				<input type="checkbox" id="checkbox13" class="css-checkbox" name="area" value="전북">
				<label for="checkbox13" class="css-label lite-green-check">전북&nbsp;&nbsp;</label>
				<br>
				<input type="checkbox" id="checkbox14" class="css-checkbox" name="area" value="제주">
				<label for="checkbox14" class="css-label lite-green-check">제주&nbsp;&nbsp;</label>
				</td>
			</tr>
			<tr>
