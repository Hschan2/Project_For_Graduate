...
if( !form.memo.value )
 ...
 String pass = "2016pocit";
	...
	try {
		...
		String sql = "SELECT USERNAME, PASSWORD, TITLE, MEMO FROM board_free WHERE NUM=" + idx;
   ...
   <table>
    ...
    <tr>
     ...
     <tr align="center">
      ...
      <td colspan="2">
	  <br>
	  <input class="freebutton" type="button" value="수정" OnClick="javascript:modifyCheck();">
