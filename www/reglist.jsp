...
try{
	...
	String sql = "select count(*) from user_personal";
	...
	String sqlList = "select user_number, title, hire, sex, special, area from user_personal order by user_number desc";
...
<tr>
	<td><%=idx %></a></td>
	<td><a href="personalok.jsp?user_number=<%=idx %>"><%=title %></td>
	<td><%=hire %></td>
	<td><%=sex %></td>
	<td><%=special %></td>
	<td><%=area %></td>
