...
<%
		...
		try{
			...
			String sqlList3 = "select number, name, grade from company_eval order by grade desc limit 3";
...
<div id="content">
       ...
       <div class="row">
		...
		<td style="border:0px; padding:2px;" align = "right"><a href = "assesslist.jsp">more</a></td>
		</tr>
		</table><p>
	    <div id = "boardline"></div>
		 <table width="600" cellpadding="0" cellspacing="0" id="board" align = "left" style="border:2px solid #ccc">
		...
		%>
            <tr>
				...
				if(grade == 0){
				%>
				<td width="100" style="border:0px; padding:2px;">☆☆☆☆☆</td>
				<%
				} else if(grade == 1){
				%>
				<td width="100" style="border:0px; padding:2px;">★☆☆☆☆</td>
