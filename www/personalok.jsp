...
try{
	...
	String sql = "select user_number, title, hire, sex, area, week, time1, time2, special, language, money, renew, number from user_personal where user_number =" + idx;
...
List<String> language = new ArrayList<String>(); 
 while(rs.next()){
		...
		area.add(new String(rs.getString(5)));
		...
		int phonenumber = Integer.parseInt(rs.getString(13));
%>
		
		<table class = "two" width = "100%">
			<tr>
				<th bgcolor = "#EAEAEA" width = "150">게시물 번호</th>
				<td>
				<%= number %>
				</td>
			</tr>
			...
			<tr>
				<th bgcolor = "#EAEAEA" width = "150">지역</th>
				<td>
				<%= rs.getString(5) %><%= " " %>
				</td>
			</tr>
			...
			<%
			String sql2 = "select phone_number from user where user_number =" + phonenumber;
		...
		<table width = "100%" style = "border-width : 0px;">
			...
			<input class="regbutton" name="ok" type="button" onclick = "location.href='reglist.jsp'"  value="목록" />
			</td>
			</tr>
		</table>
		</div>	
